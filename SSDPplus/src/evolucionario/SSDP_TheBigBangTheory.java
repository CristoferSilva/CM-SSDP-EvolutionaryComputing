 ...
 * @author TARCISIO
 */
public class SSDP_TheBigBangTheory {
...
//        Avaliador.imprimirDimensaoQuantidade(P, P.length, 15);
        ...
        for(int numeroReinicializacoes = 0; numeroReinicializacoes < 3; numeroReinicializacoes++){//Controle número de reinicializações
            ...
            while(numeroGeracoesSemMelhoraPk < 3){
                ...
                if(indiceGeracoes == 1){
                    ...
                    //ALTERAR AQUIIIIIIII BIG BANGGGG
    ...
    public static void main(String args[]) throws FileNotFoundException{
        ...
        //Data set                    ***************
        //*******************************************
        String caminho = "./SSDPplus/pastas/bases"; 
        ...
        String caminhoBase = "./SSDPplus/pastas/bases/matrixBinaria-Global-100-p.csv";
